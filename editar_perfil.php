...
<!DOCTYPE html>
  <html lang="pt-br">
    <head> 
      ...
      <meta name="descryption" content="Entretenimento Online">
    ...
    <body>
      ...
      <nav class="purple lighten-2">
          <div class="nav-wrapper container">
            <a href="painel.php" class="brand-logo"><img class="logo" src="img/logo.svg"></a>
      ...
      <!-- HOME -->
        <section class="home bloco" id="home">
